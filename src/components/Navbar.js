            ...
            <div className="flex items-center justify-between  px-10">
                <div className="flex space-x-10">
                    ...
                    <ul className="hidden  items-center md:flex text-lg tracking-widest">
                        ...
                        <li>
                            <NavLink style={({ isActive }) => ({ color: isActive ? 'cyan' : 'white' })} to="/dashboard" className='mx-1 px-2 font-semibold'>Dashboard</NavLink>
                        </li>
                        <li>
                            <NavLink style={({ isActive }) => ({ color: isActive ? 'cyan' : 'white' })} to="/rewards" className='mx-1 px-2 font-semibold'>Rewards</NavLink>
                        </li>
                        <li>
                            <NavLink style={({ isActive }) => ({ color: isActive ? 'cyan' : 'white' })} to="/datamarket" className='mx-1 px-2 font-semibold'>Data Market</NavLink>
                        </li>
                    </ul>
